...
resource "digitalocean_droplet" "www-ohmyform" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # create ohmyform installation directory
      "mkdir /root/ohmyform",
    ]
  }

  provisioner "file" {
    source      = "default.conf.tpl"
    destination = "/root/ohmyform/default.conf"
  }
  ...
  provisioner "file" {
    ...
    destination = "/root/ohmyform/docker-compose.yml"
  }
